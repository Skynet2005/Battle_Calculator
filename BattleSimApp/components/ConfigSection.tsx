  ...
  <View style={styles.panel}>
        ...
        <View style={[styles.radioContainer, { marginTop: 8 }]}>
          {(["solo", "rally"] as const).map((opt) => (
            ...
            >
              ...
              <View
                style={[styles.radioButton, p.attackType === opt && styles.radioButtonSelected]}
              >
    ...
    <View style={[styles.row, styles.inlineRow]}>
      <View style={styles.halfCol}>
        <Text style={styles.label}>Attacker {p.attackType === "rally" ? "Rally" : "March"} Capacity</Text>
        <TextInput
          style={styles.input}
      ...
      <View style={styles.halfCol}>
        <Text style={styles.label}>Defender {p.attackType === "rally" ? "Rally" : "March"} Capacity</Text>
        <TextInput
          style={styles.input}
